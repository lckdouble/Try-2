...
class PrecompDataset(data.Dataset):
    ...
    def __init__(self, data_path, data_split, vocab):
        # data_split is train, test or dev
        self.vocab = vocab
        loc = data_path + '/'
        ...
        # rkiros data has redundancy in images, we divide by 5, 1 crop doesn't
...
def get_precomp_loader(data_path, data_split, vocab, opt, batch_size=100,
    ...
    """Returns torch.utils.data.DataLoader for custom coco dataset（自定义数据集）."""
